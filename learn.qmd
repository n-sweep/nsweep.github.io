...
Book a short introductory call with me (at no cost) where we can get to know each other and discuss your needs. If it's a good fit, we will schedule a regular, recurring appointment!
...
Are you brand new to coding? Or maybe you've given it a shot (or a few) but you feel stuck in "[tutorial hell](https://blog.boot.dev/education/building-your-first-coding-project/)"? Let's get started (or start getting out) together!
...
Session Type      | Cost $/30m | Session Length | Total per Sess.
----------------- | ---------- | -------------- | ---------------
1 on 1 by Month   | $20 / 30m  | Choice (90m*)  |   Varies ($60**)
1 on 1 by Session | $30 / 30m  | Choice (90m*)  |   Varies ($90**)
Class by Month^   | $15 / 30m  |         120m   |             $60
...
<sub>\* Length of 1-on-1 sessions can be chosen; 90 minutes recommended.<br />
** Total per session depends on chosen session length. Value shown is for 90 minutes.<br />
^ Classes are not always available, reach out for more information & to be added to the waitlist.</sub>
